    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="product col-xl-3 col-lg-4 col-sm-6">
          ...
          <div class="py-2">
            <p class="text-muted text-sm mb-1">culture</p>
            <h3 class="h6 text-uppercase mb-1"><a href="detail.html" class="text-dark">la bouche</a></h3><span class="text-muted">40€</span>
          </div>
        </div>
        <!-- /product-->
        <!-- product-->
        <div class="product col-xl-3 col-lg-4 col-sm-6">
            <div class="product-image">
              <a href="detail.html" class="product-hover-overlay-link">
                <img src="assets/images/produits/14-shark_tn.jpg" alt="product" class="img-fluid">
              </a>
            </div>
            <div class="product-action-buttons">
              <a href="#" class="btn btn-outline-dark btn-product-left"><i class="fa fa-shopping-cart"></i></a>
            ...
            <div class="py-2">
              <p class="text-muted text-sm mb-1">animal</p>
              <h3 class="h6 text-uppercase mb-1"><a href="detail.html" class="text-dark">albator</a></h3><span class="text-muted">20€</span>
            </div>
          </div>
          <!-- /product-->
          <!-- product-->
        <div class="product col-xl-3 col-lg-4 col-sm-6">
            <div class="product-image">
              <a href="detail.html" class="product-hover-overlay-link">
                <img src="assets/images/produits/18-pokeball_tn.jpg" alt="product" class="img-fluid">
              </a>
            </div>
            <div class="product-action-buttons">
              <a href="#" class="btn btn-outline-dark btn-product-left"><i class="fa fa-shopping-cart"></i></a>
            ...
            <div class="py-2">
              <p class="text-muted text-sm mb-1">savoir</p>
              <h3 class="h6 text-uppercase mb-1"><a href="detail.html" class="text-dark">ailleurs</a></h3><span class="text-muted">50€</span>
            </div>
          </div>
          <!-- /product-->
          <!-- product-->
        <div class="product col-xl-3 col-lg-4 col-sm-6">
            ...
            <div class="py-2">
              <p class="text-muted text-sm mb-1">espace</p>
              <h3 class="h6 text-uppercase mb-1"><a href="detail.html" class="text-dark">trou noir</a></h3><span class="text-muted">15€</span>
            </div>
          </div>
          <!-- /product-->
