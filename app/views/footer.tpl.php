        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              <li> <a href="#" class="text-muted">Romans</a></li>
              <li> <a href="#" class="text-muted">Bandes dessinée</a></li>
              <li> <a href="#" class="text-muted">Policiers</a></li>
              <li> <a href="#" class="text-muted">Mangas</a></li>
              <li> <a href="#" class="text-muted">Fiction</a></li>
            </ul>
          </div>
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
