...
<section>
  <div class="container-fluid">
    <div class="row mx-0">
      <?php for ($i = 0; $i <= 1; $i++) : ?>
        <?php $categoryObject = $home_categories[$i]; ?>
        <div class="col-md-6">
          <div class="card border-0 text-center"><img src="<?= $categoryObject->getPicture() ?>" alt="Card image" class="card-img">
    ...
    <div class="row mx-0"> 
        <?php for ($i = 2 ; $i <= 4 ; $i++): ?>
          <?php $categoryObject = $home_categories[$i]; ?>
          <div class="col-lg-4">
            <div class="card border-0 text-center "><img src="<?= $categoryObject->getPicture() ?>"
